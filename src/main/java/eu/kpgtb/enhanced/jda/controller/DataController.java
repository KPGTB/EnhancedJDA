...
public class DataController {
    ...
    public void enable() {
        this.bot.getLogger().info("Connecting to database...");
        ...
        if(databaseStr.equalsIgnoreCase("SQLITE")) {
            ...
            if(!dbFile.exists()) {
                try {
                    ...
                    this.bot.getLogger().error("Error when creating SQLITE database file");
                    e.printStackTrace();
                    return;
                }
            }
            ...
            try {
                ...
                this.connectionSource = null;
                this.bot.getLogger().error("Error when connection to SQLITE");
                e.printStackTrace();
                return;
            }
        } else {
            try {
                ...
                this.connectionSource = null;
                this.bot.getLogger().error("Error when connection to MySQL");
                e.printStackTrace();
                return;
            }
        }
        ...
        this.bot.getLogger().info("Connected to database");
    }
